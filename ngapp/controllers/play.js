/* Kharbga controller */
nsApp.controller('kharbgaController', ['$scope', '$state', '$stateParams', '$rootScope', '$http', 'localStorageService' , 'appConstants',
    function ($scope, $tsate, $stateParams, $rootScope, $http, localStorageService, appConstants) {
